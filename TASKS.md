...
- [ ] Define ANF.Semantics small-step LTS — TODO(supervisor): Add a supervisor validation entry for `Define ANF.Semantics small-step LTS` in `TASKS.md` after running the task validation workflow.

...
private theorem closureConvert_step_simulation
  ...
  | var name =>
    ...
    | none =>
      ...
      | some fv =>
        ...
        · exact ⟨st, st, by simp [sc', Flat.convertExpr, hfvcv], ⟨rfl, rfl⟩, by simp_all [Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr, CCStateAgree]⟩
      | none =>
        ...
        · exact ⟨st, st, by simp [sc', Flat.convertExpr, Flat.convertValue], ⟨rfl, rfl⟩, by simp_all [Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr, CCStateAgree]⟩
  | «this» =>
    rw [hsc] at hconv hncfr hexprwf hd
    simp [Flat.convertExpr] at hconv
    obtain ⟨hfexpr, hst_eq⟩ := hconv
    ...
    | some cv =>
      ...
      · have hscope := convertExpr_scope_irrelevant body scope (name :: scope) envVar envMap st
        exact ⟨st, (Flat.convertExpr body scope envVar envMap st).snd, by
          simp only [sc']; rw [hscope], ⟨rfl, rfl⟩, by simp_all [Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr, CCStateAgree]⟩
    | none =>
      ...
      · sorry -- conversion relation for let stepping — same CCState issue as if stepping
  | assign name rhs =>
    rw [hsc] at hconv hncfr hexprwf hd
    simp [Flat.convertExpr] at hconv
    ...
    | some cv =>
      ...
      · exact ⟨st, st, by simp only [sc']; simp [Flat.convertExpr, Flat.convertValue], ⟨rfl, rfl⟩, by simp_all [Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr, CCStateAgree]⟩
    | none =>
      ...
      · exact ⟨st_a, st_a', by
          ...
          exact ⟨congrArg Prod.fst hconv', congrArg Prod.snd hconv'⟩, hAgreeIn, by rw [hst]; exact hAgreeOut⟩
  | «if» cond then_ else_ =>
    rw [hsc] at hconv hncfr hexprwf hd
    simp [Flat.convertExpr] at hconv
    ...
    | some cv =>
      ...
      | true =>
        ...
        · exact ⟨st, (Flat.convertExpr then_ scope envVar envMap st).snd, by
            simp [sc', Flat.convertExpr], ⟨rfl, rfl⟩, by simp_all [Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr, CCStateAgree]⟩
      | false =>
        ...
        · exact ⟨(Flat.convertExpr then_ scope envVar envMap st).snd,
            ...
            simp [sc', Flat.convertExpr], hAgreeIn, by rw [hst]; exact hAgreeOut⟩
    | none =>
  ...
  | unary op arg =>
    ...
    | some cv =>
      ...
      · refine ⟨st, st, ?_, ⟨rfl, rfl⟩, by simp_all [Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr, CCStateAgree]⟩
  ...
  | binary op lhs rhs =>
    ...
    | some lv =>
      ...
      | some rv =>
        ...
        · exact ⟨st, st, by
            simp [sc', Flat.convertExpr, evalBinary_convertValue], ⟨rfl, rfl⟩, by simp_all [Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr, CCStateAgree]⟩
      | none =>
  ...
  | «return» val =>
    ...
    | none =>
      ...
      · simp [sc', noCallFrameReturn]
      · simp [sc', ExprAddrWF, ValueAddrWF]
      · exact ⟨st, st, by simp [sc', Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr], ⟨rfl, rfl⟩, by simp_all [Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr, CCStateAgree]⟩
    | some e =>
      simp [Flat.convertExpr, Flat.convertOptExpr] at hconv
      obtain ⟨hfexpr, hst⟩ := hconv
  ...
  | labeled label body =>
    ...
    · exact ⟨st, (Flat.convertExpr body scope envVar envMap st).snd, by simp [sc'], ⟨rfl, rfl⟩, by simp_all [Flat.convertExpr, Flat.convertValue, Flat.convertOptExpr, CCStateAgree]⟩
  | yield arg delegate =>
    rw [hsc] at hconv hncfr hexprwf hd
    cases arg with
    | none =>

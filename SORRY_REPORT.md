...
- [ ] `VerifiedJS/Proofs/ANFConvertCorrect.lean:321` — `theorem normalizeExpr_not_trivial_family` — `all_goals sorry -- tryCatch/while_ monadic bind chains`
- [ ] `VerifiedJS/Proofs/ANFConvertCorrect.lean:516` — `theorem anfConvert_halt_star` — `all_goals sorry`
